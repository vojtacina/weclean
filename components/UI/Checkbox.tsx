...
export default function Checkbox({label, checked, setChecked}:CheckboxType) {
    ...
    return (
        <div className="flex items-center gap-x-3 group cursor-pointer" onClick={() => setChecked(!checked)}>
            <div className={`w-5 h-5 flex-shrink-0 rounded flex items-center justify-center  ${checked ? " bg-blue-primary border-none " : " border border-gray-300 group-hover:border-gray-200 "}`}>
