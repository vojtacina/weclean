...
function FeaturedPngSection(props: Props) {
    ...
    const sm = useIsMobile("sm")

    return (
        <section className="w-full py-8 mt-8 md:py-24 overflow-hidden">
            <MaxWidthWrapper>
                <div className="w-full grid md:grid-cols-5">
                    <div className="md:col-span-3 md:pr-24 order-2 md:order-1 mt-8 md:mt-0">
                        ...
                        <div className="md:inline-flex mt-4">
                            <RenderButton button={data.button} primary={sm ? false : true} />
                        </div>

                    </div>
                    <div className="md:col-span-2 order-1 md:order-2 relative h-32 md:h-auto">
